...
final class ClientTest extends TestCase
{
    public function testUsesEnvSecretKeyByDefault(): void
    {
        ...
        $fixture = FixtureLoader::load('public-api/sessions/list.json');
    ...
    public function testListsSessionsWithNormalizedPaginationAndAuthHeaders(): void
    {
        ...
        self::assertSame('cur_sessions_page_2', $result->nextCursor);
        self::assertSame($fixture['data'][0]['id'], $result->items[0]->id);
    }

    public function testIteratesPaginatedSessionResults(): void
    {
        $firstPage = FixtureLoader::load('public-api/sessions/list.json');
        $secondPage = [
            'data' => [
                [
                    ...$firstPage['data'][0],
    ...
    {
        $listFixture = FixtureLoader::load('public-api/fingerprints/list.json');
    ...
    public function testParsesPublicApiErrorsIntoTripwireApiError(): void
    {
        ...
        $httpClient = new TestHttpClient(static fn (RequestInterface $request) => JsonResponse::create(
            ...
            ['x-request-id' => $fixture['error']['requestId']],
        ));
        ...
        try {
            ...
            self::assertSame($fixture['error']['docsUrl'], $error->docsUrl);
        }
    }
}
